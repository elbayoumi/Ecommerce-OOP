!function(t, e) {
    ...
    m.open = "0", m.close = "1", m.ping = "2", m.pong = "3", m.message = "4", m.upgrade = "5", 
    m.noop = "6";
    ...
    var C = "function" == typeof ArrayBuffer, B = function(t, e) {
        ...
        if (C) {
            var n = function(t) {
                ...
                for (e = 0; e < a; e += 4) n = R[t.charCodeAt(e)], r = R[t.charCodeAt(e + 1)], i = R[t.charCodeAt(e + 2)], 
                o = R[t.charCodeAt(e + 3)], h[c++] = n << 2 | r >> 4, h[c++] = (15 & r) << 4 | i >> 2, 
                h[c++] = (3 & i) << 6 | 63 & o;
                return u;
            }(t);
            return N(n, e);
    ...
    function D(t, e) {
        e.useNativeTimers ? (t.setTimeoutFn = q.bind(P), t.clearTimeoutFn = I.bind(P)) : (t.setTimeoutFn = P.setTimeout.bind(P), 
    ...
    var F, M = function(t) {
        ...
        function i(t, r, o) {
            var s;
            return e(this, i), (s = n.call(this, t)).description = r, s.context = o, s.type = "TransportError", 
            s;
        }
        return r(i);
        ...
        function i(t) {
            var r;
            return e(this, i), (r = n.call(this)).writable = !1, D(f(r), t), r.opts = t, r.query = t.query, 
            r.socket = t.socket, r;
        }
        return r(i, [ {
            key: "onError",
    ...
    var tt = null != new G({
        ...
        function i(t, r) {
            var o;
            return e(this, i), D(f(o = n.call(this)), r), o.opts = r, o.method = r.method || "GET", 
    ...
    var it = "function" == typeof Promise && "function" == typeof Promise.resolve ? function(t) {
        ...
        return e(t, 0);
    }, ot = P.WebSocket || P.MozWebSocket, st = "undefined" != typeof navigator && "string" == typeof navigator.product && "reactnative" === navigator.product.toLowerCase(), at = function(t) {
        o(i, t);
        var n = p(i);
        function i(t) {
            var r;
        ...
        websocket: at,
        polling: et
    }, ut = /^(?:(?![^:@\/?#]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@\/?#]*)(?::([^:@\/?#]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/, ht = [ "source", "protocol", "authority", "userInfo", "user", "password", "host", "port", "relative", "path", "directory", "file", "query", "anchor" ];
    function ft(t) {
    ...
    var lt = function(n) {
        ...
        function a(n) {
            ...
            return e(this, a), (r = s.call(this)).writeBuffer = [], n && "object" === t(n) && (o = n, 
            n = null), n ? (n = ft(n), o.hostname = n.host, o.secure = "https" === n.protocol || "wss" === n.protocol, 
            o.port = n.port, n.query && (o.query = n.query)) : o.host && (o.hostname = ft(o.host).host), 
            D(f(r), o), r.secure = null != o.secure ? o.secure : "undefined" != typeof location && "https:" === location.protocol, 
            o.hostname && !o.port && (o.port = r.secure ? "443" : "80"), r.hostname = o.hostname || ("undefined" != typeof location ? location.hostname : "localhost"), 
            r.port = o.port || ("undefined" != typeof location && location.port ? location.port : r.secure ? "443" : "80"), 
            r.transports = o.transports || [ "polling", "websocket" ], r.writeBuffer = [], r.prevBufferLen = 0, 
            r.opts = i({
                path: "/engine.io",
                agent: !1,
                withCredentials: !1,
            ...
            }, o), r.opts.path = r.opts.path.replace(/\/$/, "") + (r.opts.addTrailingSlash ? "/" : ""), 
            "string" == typeof r.opts.query && (r.opts.query = J(r.opts.query)), r.id = null, 
            r.upgrades = null, r.pingInterval = null, r.pingTimeout = null, r.pingTimeoutTimer = null, 
        ...
        return r(a, [ {
            ...
            value: function(t) {
                ...
                var f = function() {
                    n.removeListener("open", i), n.removeListener("error", s), n.removeListener("close", c), 
                    e.off("close", u), e.off("upgrading", h);
                };
                n.once("open", i), n.once("error", s), n.once("close", c), this.once("close", u), 
            ...
            value: function() {
                ...
                this.emitReserved("open"), this.flush(), "open" === this.readyState && this.opts.upgrade) for (var t = 0, e = this.upgrades.length; t < e; t++) this.probe(this.upgrades[t]);
            }
        }, {
            key: "onPacket",
            value: function(t) {
            ...
            value: function(t) {
                ...
                this.pingTimeout = t.pingTimeout, this.maxPayload = t.maxPayload, this.onOpen(), 
            ...
            value: function() {
                ...
                for (var t, e = 1, n = 0; n < this.writeBuffer.length; n++) {
                    ...
                    if (r && (e += "string" == typeof (t = r) ? function(t) {
                        for (var e = 0, n = 0, r = 0, i = t.length; r < i; r++) (e = t.charCodeAt(r)) < 128 ? n += 1 : e < 2048 ? n += 2 : e < 55296 || e >= 57344 ? n += 3 : (r++, 
                        n += 4);
                        return n;
            ...
            value: function(t, e, n, r) {
                ...
                n = null), "closing" !== this.readyState && "closed" !== this.readyState) {
                    ...
                    this.emitReserved("packetCreate", i), this.writeBuffer.push(i), r && this.once("flush", r), 
                    this.flush();
                }
            }
        }, {
            ...
            value: function(t, e) {
                ...
                this.id = null, this.emitReserved("close", t, e), this.writeBuffer = [], this.prevBufferLen = 0);
            }
        }, {
            key: "filterUpgrades",
            value: function(t) {
    ...
    var Ot = function() {
        ...
        return r(t, [ {
            ...
            value: function(t) {
                ...
                t.nsp && "/" !== t.nsp && (e += t.nsp + ","), null != t.id && (e += t.id), null != t.data && (e += JSON.stringify(t.data, this.replacer)), 
                e;
            }
        }, {
            key: "encodeAsBinary",
        ...
        return r(a, [ {
            ...
            value: function(t) {
                ...
                if ("string" == typeof t) {
                    ...
                    n || e.type === Et.BINARY_ACK ? (e.type = n ? Et.EVENT : Et.ACK, this.reconstructor = new Rt(e), 
    ...
    var Bt = Object.freeze({
        ...
        function a(t, r, o) {
            var s;
            return e(this, a), (s = n.call(this)).connected = !1, s.recovered = !1, s.receiveBuffer = [], 
            s.sendBuffer = [], s._queue = [], s.ids = 0, s.acks = {}, s.flags = {}, s.io = t, 
            s.nsp = r, o && o.auth && (s.auth = o.auth), s._opts = i({}, o), s.io._autoConnect && s.open(), 
            s;
        }
        return r(a, [ {
            key: "disconnected",
            ...
            value: function(t) {
                ...
                for (var e = arguments.length, n = new Array(e > 1 ? e - 1 : 0), r = 1; r < e; r++) n[r - 1] = arguments[r];
                if (n.unshift(t), this._opts.retries && !this.flags.fromQueue && !this.flags.volatile) return this._addToQueue(n), 
                this;
                var i = {
                    type: Et.EVENT,
                    data: n,
                ...
                return c || (this.connected ? (this.notifyOutgoingListeners(i), this.packet(i)) : this.sendBuffer.push(i)), 
                this.flags = {}, this;
            }
        }, {
            ...
            value: function(t) {
                ...
                t.push(function(t) {
                    if (r === n._queue[0]) {
                        var i = null !== t;
                        if (i) r.tryCount > n._opts.retries && (n._queue.shift(), e && e(t)); else if (n._queue.shift(), 
                        e) {
            ...
            key: "onconnect",
            value: function(t, e) {
                this.id = t, this.recovered = e && this._pid === e, this._pid = e, this.connected = !0, 
                this.emitBuffered(), this.emitReserved("connect");
            }
        }, {
            key: "emitBuffered",
            value: function() {
            ...
            key: "onAnyOutgoing",
            value: function(t) {
                return this._anyOutgoingListeners = this._anyOutgoingListeners || [], this._anyOutgoingListeners.push(t), 
                this;
            }
        }, {
            key: "prependAnyOutgoing",
            value: function(t) {
                return this._anyOutgoingListeners = this._anyOutgoingListeners || [], this._anyOutgoingListeners.unshift(t), 
                this;
            }
        }, {
            key: "offAnyOutgoing",
            value: function(t) {
                ...
                if (t) {
                    for (var e = this._anyOutgoingListeners, n = 0; n < e.length; n++) if (t === e[n]) return e.splice(n, 1), 
                    this;
    ...
    var xt = function(n) {
        ...
        function s(n, r) {
            var o, a;
            e(this, s), (o = i.call(this)).nsps = {}, o.subs = [], n && "object" === t(n) && (r = n, 
            n = void 0), (r = r || {}).path = r.path || "/socket.io", o.opts = r, D(f(o), r), 
            o.reconnection(!1 !== r.reconnection), o.reconnectionAttempts(r.reconnectionAttempts || 1 / 0), 
            o.reconnectionDelay(r.reconnectionDelay || 1e3), o.reconnectionDelayMax(r.reconnectionDelayMax || 5e3), 
            ...
            var c = r.parser || Tt;
            return o.encoder = new c.Encoder(), o.decoder = new c.Decoder(), o._autoConnect = !1 !== r.autoConnect, 
            o._autoConnect && o.open(), o;
        }
        return r(s, [ {
            key: "reconnection",
            value: function(t) {
            ...
            value: function(t, e) {
                var n = this.nsps[t];
                return n || (n = new St(this, t, e), this.nsps[t] = n), this._autoConnect && n.connect(), 
                n;
            }
        }, {
            key: "_destroy",
            ...
            key: "onclose",
            value: function(t, e) {
                this.cleanup(), this.backoff.reset(), this._readyState = "closed", this.emitReserved("close", t, e), 
    ...
    function Pt(e, n) {
        ...
        var r, i = function(t) {
            ...
            r = ft(t)), r.port || (/^(http|ws)$/.test(r.protocol) ? r.port = "80" : /^(http|ws)s$/.test(r.protocol) && (r.port = "443")), 
            r.path = r.path || "/";
            var i = -1 !== r.host.indexOf(":") ? "[" + r.host + "]" : r.host;
            return r.id = r.protocol + "://" + i + ":" + r.port + e, r.href = r.protocol + "://" + i + (n && n.port === r.port ? "" : ":" + r.port), 
            r;
        ...
        r = Lt[s]), i.query && !n.query && (n.query = i.queryKey), r.socket(i.path, n);
    }
    return i(Pt, {
        Manager: xt,
        Socket: St,
